...
export default function ResearchHook({
  ...
  return (
    <section
      ref={ref}
      className="lattice relative overflow-hidden border-y-4 border-[#3A2E26] px-4 py-8 sm:px-6 sm:py-12"
      style={{ background: bg }}
    >
      <motion.div
        ...
        className="mx-auto flex max-w-6xl flex-col items-start gap-5 sm:gap-7 lg:flex-row lg:items-center lg:justify-between"
      >
        <div className="flex items-center gap-4 sm:gap-6">
          {/* The number does the selling */}
          <div
            className="flex-none border-2 px-4 py-2.5 sm:px-5 sm:py-3"
